            ...
            <form class="form-horizontal" method="post" action="${path }/admin/meetuser">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-2 btn-group pull-right">
                        <a href="${path }/admin/meetuser/add?meetingid=${record.meetingid}" class="btn btn-info btn-sm ">新增</a>
...
<c:if test="${s.id==d.preuserid}">${s.name}</c:if>
                                </c:forEach>
                            </td>

                            <td>

                                <a  class="btn btn-danger btn-sm btn-icon icon-left" href="${path}/admin/meetuser/del?id=${d.id }" >删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
