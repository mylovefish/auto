            ...
            <div class="col-sm-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form role="form" class="form-horizontal"  action="<c:if test="${edit==true }">${path }/admin/notice/update</c:if><c:if test="${edit==false }">${path }/admin/notice/add</c:if><c:if test="${edit==null }">${path }/admin/notice/save</c:if>" method="post">
                            <input type="hidden" name="id" value="${record.id }">
                                        <div class="form-group">
                                           <label class="col-sm-2 control-label" for="title">标题</label>
                                            <div class="col-sm-10">
                                                <input required type="text" class="form-control " <c:if test="${edit==false }">disabled</c:if> name="title" value="${record.title}" id="title" placeholder="标题">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                           <label class="col-sm-2 control-label" for="desc">正文</label>
                                            <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <c:if test="${edit==false }"><a href="${path }/admin/notice" class="btn btn-gray btn-single">返回</a></c:if>
