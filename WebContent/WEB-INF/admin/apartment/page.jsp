...
<div class="page-container">
    ...
    <div class="main-content">
        ...
        <div class="page-title">
            ...
            <form class="form-horizontal" method="post" action="${path }/admin/apartment">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-2 btn-group pull-right">
                        <a href="${path }/admin/apartment/add" class="btn btn-info btn-sm ">新增</a>
                    ...
                    <c:forEach var="d" items="${datas.data }">
                        <tr>
                            ...
                            <td>
                                ...
                                <a  class="btn btn-secondary btn-sm btn-icon icon-left" href="${path}/admin/apartment/view?id=${d.id }" >查看</a>
                                <a  class="btn btn-info btn-sm btn-icon icon-left" href="${path}/admin/apartment/edit?id=${d.id }" >编辑</a>
                                <a  class="btn btn-danger btn-sm btn-icon icon-left" href="${path}/admin/apartment/del?id=${d.id }" >删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
